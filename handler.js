...
if (db.data.chats[m.chat].reaction && m.text.match(/(nadaaaaaaaaa)/gi)) {
...
if (msg) return m.reply(msg) //conn.relayMessage(m.chat, prep.message, { messageId: prep.key.id })
}
