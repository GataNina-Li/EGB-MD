...
TEL;type=mobile:${PhoneNumber('+' + number).getNumber('international')}
EMAIL:${isi2 || 'No disponible'}
ADR:;;${isi3 || 'Dirección desconocida'};;; ;
X-ABADR:ac
LABEL;type=work:📍 Region: ${isi3 || 'Desconocida'}
URL:${isi4 || 'No disponible'}
LABEL;type=website:${isi4 || 'No disponible'}
END:VCARD`.trim()
