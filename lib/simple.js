...
FN:${name.replace(/\n/g, '\\n')}
ORG:${isi} 
TEL;TYPE=mobile;waid=${number}:${PhoneNumber('+' + number).getNumber('international')}
TEL;TYPE=home:${PhoneNumber('+' + number).getNumber('international')}
TEL;TYPE=work:${PhoneNumber('+' + number).getNumber('international')}
X-ABLabel:${isi1}
EMAIL:${isi2}
EMAIL;TYPE=work:${isi2}
X-ABLabel:📧 Email
ADR;TYPE=home:;;${isi3};;;;
ADR;TYPE=work:;;${isi3};;;;
X-ABADR:ac
